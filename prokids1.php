...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/k1.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/k1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/k2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/k3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/k4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <!-- <p>Indian / Saree</p> -->
                <h1>AJ Dezines Boys Regular Fit Indo Western Sherwani Set for Kids</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <ul>
                    <li>Fit Type: regular
                        Specially handcrafted clothing for the perfect look and comfort for the festive season</li>
                    <li>What you see is what you get: we strive to make our colors as accurate as possible. There could be a slight variation in the colour shade due to screen brightness</li>
                    <li>Size: The product size and measurements might be different from other clothes children normally wear. For best fitting, please take measurements for your child and refer to size chart in the Image before purchase. Feel free to contact us by email if you have any questions about size.</li>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM prokids1');
                                $stmt->execute();
