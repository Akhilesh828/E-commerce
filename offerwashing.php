...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/offerwash1.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/offerwash1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offerwash2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offerwash3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offerwash4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <h1>LG 7 kg Semi-Automatic Top Loading Washing Machine (P7010RRAA, Burgundy)</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>

                    <li>Semi-automatic washing Machine: Economical, Low water and energy consumption, involves manual effort; Has both washing and drying functions</li>
                    <li>Capacity 7.0 kg (wash): Suitable for large families</li>
                    <li>Manufacturer Warranty: 2 Years Comprehensive
                        1300 RPM: higher spin speeds helps in faster drying</li>
                    <li>Also included in box: 1 Unit of Machine, 1 Unit of Drain Hose,1 unit of User Manual,1 Unit of QRG, 1 unit of Detergent Powder(200gm Packet)</li>
                    <li>Special features: Electro Mechanical Control System, Lint Collector, Collar Cleaner, Water Level Selector, Spin Window, Cold Water Inlet, unidirectional wheels, Anti Vibration Rubber, Spin Shower, Wash Window, Rust Free Plastic Base , wind jet dry</li>
                </p>
                <br>
                <h3>PRICE - &#8377 10,990 &nbsp;&nbsp;&nbsp; M.R.P -<s style="color: grey;"> &#8377 13,990</s></h3>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM offerwashing');
                                $stmt->execute();
