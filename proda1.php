...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/da1.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/da1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da1.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da1.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da1.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <h1>Ariel Matic 3in1 PODs Liquid Detergent Pack 18 Count for Both Front Load and Top Load Washing Machines</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                <ol style="list-style-type: circle;">
                    <li>Newly launched one-dose detergent capsules</li>
                    <li>Ariel 3in1 PODs has 3 unique chambers that work had to clean, lift stains and brighten clothes</li>
                    <li>1 POD is enough for normal load. For heavy/large load, please use 2 PODs</li>
                    <li>Item Weight: 357.0 Grams; Unit Count Type: Count</li>
                </ol>

                </p>
                <h4>&#8377 528 <s>&#8377 704</s>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proda1');
                                $stmt->execute();
