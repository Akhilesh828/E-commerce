...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/gh1.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/gh1.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/gh2.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/gh3.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/gh4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <p>Prakhya</p>
                <h1>Women Blue Floral Embroidered Kurta with Trousers & With Dupatta</h1>
                ...
                <p>
                    <li>Kurta design:
                        ...
                        Straight shape
                        Regular style
                        Scoop neck, three-quarter regular sleeves
                        Calf length with straight hem
                        Viscose rayon knitted fabric
                    </li>
                    <li>Embroidered Trousers
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proghdetails8');
                                $stmt->execute();
