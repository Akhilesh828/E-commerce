...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/english_navy_formal_white_shirt_4.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/english_navy_formal_white_shirt_4.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/english_navy_formal_white_shirt_1.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/english_navy_formal_white_shirt_2.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/english_navy_formal_white_shirt_3.webp" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <br>
                <ul>
                    <li>White solid formal shirt, has a spread collar, long sleeves, straight hem, one patch pocket</li>
                    <li>Size & Fit
                        Slim fit
                ...
                <h3>PRICE - &#8377 1,799 &nbsp;&nbsp;&nbsp; <s style="color: grey;"> &#8377 4,999</s></h3>
                <h3 style="color: red;">67% OFF</h3>
                <select name="" id="">
...
------------------------------------------------------------------------- -->
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="proformensdetails2.php"><img src="images/hancock_formal_navy_blue_shirt_1.webp" alt=""></a>
