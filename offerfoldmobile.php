...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/fold1.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/fold2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/fold3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/fold4.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/fold1.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <p>Mobiles</p>
                <h1>Samsung Galaxy Z Fold3 5G (Phantom Black, 12GB RAM, 256GB Storage)</h1>
                ...
                <p>
                    ...
                    <li><b>Main Display</b> - 19.19cm (7'6") Infinity Flex Display with an Under Display Camera, Dynamic AMOLED 2X with Adaptive Refresh Rate. Cover Display - 15.82cm (6.2”) Infinity-O Display, Switchable 60/120Hz</li>

                    <li>Fingerprint Sensor (side) & Facial recognition. Dual Sim (1Nano Sim + 1 Nano Sim/eSIM)</li>

                    <li>5G Ready powered by Qualcomm Snapdragon 888 Octa-Core processor.
                    </li>
                    <li>1 year <b>manufacturer warranty</b> for device and 6 months manufacturer warranty for in-box</li>
                </p>
                <br>
                <h3>PRICE - &#8377 1,49,999 &nbsp;&nbsp;&nbsp; M.R.P -<s style="color: grey;"> &#8377 1,71,999</s></h3>
                <h3 style="color: red;">13% OFF</h3>
                <!-- <select name="" id="">
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM offerfoldmobile');
                                $stmt->execute();
...
------------------------------------------sildes------------------------------------- -->
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="images/fold6.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold7.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold8.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold9.jpg" alt=""></div>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="images/fold11.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold12.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold13.jpg" alt=""></div>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="images/fold14.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold15.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/fold16.jpg" alt=""></div>
