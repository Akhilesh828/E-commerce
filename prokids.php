...
<body>
  ...
  <div class="small-conatiner">
      <div class="row">
          ...
          <div class="col-3">
            <div class="content">
              <a href="prosaree.html"><img src="images/cat-saree2.jpg" alt=""></a>
            </div>
          </div>
          <div class="col-3">
           
              <img src="images/cat-kids.webp" alt="">
    ...
    <div class="categories">
      <div class="small-conatiner">
        <div class="row">
          ...
          <div class="col-3">
            <div class="content">
              <a href="prokidsg.php"><img src="images/girl1.webp" alt=""></a>
            </div>
          </div>
...
<div class="slideshow-contoiner">
    ...
    <div id="myBtnContainer">
      ...
      <button class="btn" onclick="filterSelection('under 5-1k')"> under 500-1k</button>
      <button class="btn" onclick="filterSelection('above 1k')"> above 1k</button>
    </div>

    <!-- Portfolio Gallery Grid -->
    <div class="row">
      <div class="column under 5-1k">
        <div class="content">
          <a href=""><img src="images/kidsA1.webp" alt="Mountains" style="width:100%"></a>
          <h4> Yellow Plain Kurta
            <h3>&#8377 1,119 &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="column above 1k">
        <div class="content">
          <a href="prokids1.php"><img src="images/k1.jpg" alt="Lights" style="width:90%"></a>
          <h4>AJ Dezines Boys
            <h3>&#8377 1,139 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 1,860</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 5-1k">
        <div class="content">
          <a href=""><img src="images/kidsb1.webp" alt="Lights" style="width:100%"></a>
          <h4>Brown Plain Kurta
            <h3>&#8377 1,119 &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="column under 5-1k">
        <div class="content">
          <a href=""><img src="images/kids1.webp" alt="Car" style="width:100%"></a>
          <h4>Boys Embroidered Kurta
            <h3>&#8377 624 &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="column under 5-1k">
        <div class="content">
          <a href=""><img src="images/kids2.webp" alt="Car" style="width:100%"></a>
          <h4>Boys Printed Kurta
            <h3>&#8377 899 &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="column under 5-1k">
        <div class="content">
          <a href=""><img src="images/kids3.webp" alt="Car" style="width:100%"></a>
          <h4>Boys Solid Embroidered Kurta
            <h3>&#8377 624 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 2,499</s>
            </h3>
          </h4>
      ...
      <div class="column under 5-1k">
        <div class="content">
          <img src="images/kids4.webp" alt="Car" style="width:100%">
          <h4>Green Plain Kurta
            <h3>&#8377 599 &nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="column above 1k">
        <div class="content">
          <img src="images/kids5.webp" alt="Car" style="width:100%">
          <h4>Blue Kurta Set 
            <h3>&#8377 1,699 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 4,499</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 500">
        <div class="content">
          <a href=""><img src="images/kids6.webp" alt="Car" style="width:100%"></a>
          <h4>Blue Plain Kurta  
            <h3>&#8377 459 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 999</s>
            </h3>
      ...
      <div class="column under 5-1k">
        <div class="content">
          <img src="images/kids7.webp" alt="Car" style="width:100%">
          <h4>Pink Plain Kurta  
            <h3>&#8377 624 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 2,499</s>
            </h3>
      ...
      <div class="column under above 1k">
        <div class="content">
          <img src="images/kids8.webp" alt="Car" style="width:100%">
          <h4>Boys Silk Printed Kurta Set 
            <h3>&#8377 2,051 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 5,699</s>
            </h3>
          </h4>
          <h4>
