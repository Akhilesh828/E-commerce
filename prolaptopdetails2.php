...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <a href="https://www.youtube.com/watch?v=vYQEUhkkJTE">
                    <img src="images/lap3.webp" width="100%" id="ProductImg" alt=""></a>
            ...
            <div class="col-2">
                <p>LAPTOP</p>
                <h1>Apple MacBook Pro <br>
                    (16-inch/40.65 cm, 16GB RAM, 1TB Storage, 2.3GHz 9th Gen Intel Core i9) - Silver</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>Ninth-generation 8-core Intel Core i9 <br> processor
                    Stunning 40.65cm (16-inch) Retina <br> display with True Tone technology <br>
                    Touch Bar and Touch ID <br>
                    AMD Radeon Pro 5500M graphics with <br> GDDR6 memory
                    Ultrafast SSD <br>
                    Intel UHD Graphics 630 <br>
                    Six-speaker system with <br> force-cancelling woofers</p>
                <h4>&#8377 2,15,990</h4>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM prolaptopdetails2');
                                $stmt->execute();
