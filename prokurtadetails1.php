...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/sojanya_men_printed_kurta_01.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/sojanya_men_printed_kurta_01.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/sojanya_men_printed_kurta_02.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/sojanya_men_printed_kurta_03.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/sojanya_men_printed_kurta_04.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <p>Indian / Kurta</p>
                <h1>Men Blue & Green Printed Cotton Kurta with Churidar</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                    <li>Blue and green printed straight knee length kurta, has a mandarin collar, long sleeves, straight hem
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM prokurtadetails1');
                                $stmt->execute();
...
------------------------------------------------------------------------- -->
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="proformensdetails1.php"><img src="images/english_navy_formal_white_shirt_1.webp" alt=""></a>
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
