...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/louis_philippe_sport_blazer_4.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/louis_philippe_sport_blazer_4.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/louis_philippe_sport_blazer_3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/louis_philippe_sport_blazer_2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/louis_philippe_sport_blazer_1.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <br>
                <ul>
                    <li>Light Blue self design slim-fit blazer, has a notched lapel, single-breasted with single button closures, long sleeves, two flap pockets, and one chest welt pocket, an attached lining and a double-vented back hem</li>
                    <li>Size & Fit
                        Slim Fit
                        The model (height 6') is wearing size 40</li>
                    <li>Material & Care
                ...
                <h3>PRICE - &#8377 8,555 &nbsp;&nbsp;&nbsp; <s style="color: grey;"> &#8377 12,999</s></h3>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proformensdetails3');
                                $stmt->execute();
...
------------------------------------------------------------------------- -->
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="proformensdetails6.php"><img src="images/peter_england_formal_pink_shirt_4.jpg" alt=""></a>
            ...
            <div class="col-4">
                <img src="images/single_brested_linen_formal_blazer_2.jpg" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/van_heusen_formal_blue_shirt_4.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
