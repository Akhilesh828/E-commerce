...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/kalini_green_printed_bandhani_saree_1.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/kalini_green_printed_bandhani_saree_1.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/kalini_green_printed_bandhani_saree_2.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/kalini_green_printed_bandhani_saree_3.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/kalini_green_printed_bandhani_saree_4.webp" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <p>Indian / Saree</p>
                <h1>Pure Chiffon Saree</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <ul>
                    <li>Design Details
                        Green and red saree
                        Ethnic motifs embroidered saree with embroidered border
                        Has mirror work detail</li>
                    <li>The saree comes with an unstitched blouse piece. The blouse worn by the model might be for modelling purpose only. Check the image of the blouse piece to understand how the actual blouse piece looks like.</li>
                    <li>Size & Fit
                ...
                <h3>PRICE - &#8377 5,999 &nbsp;&nbsp;&nbsp; M.R.P -<s style="color: grey;"> &#8377 10,659</s></h3>
                <h3 style="color: red;">45% OFF</h3>
                <select name="" id="">
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM prosareedetails2');
                                $stmt->execute();
