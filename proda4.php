...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/da4.jpg" width="70%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/da4.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da4.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da4.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                <p>Daily Essentials / Liquid Disinfectant</p>
                <h1> Dettol Liquid Disinfectant for Personal Hygiene , Surface Disinfection , Floor Cleaner , Menthol Cool , (Pack of 3 - 500 ml each)</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                <ol style="list-style-type: circle;">
                    <li>DISINFECTANT LIQUID: Protects from 100 illness causing germs</li>
                    <li>MULTIPURPOSE CLEANER: Great for everyday personal and home hygiene</li>
                    <li>COOL FRAGRANCE: Anti-bacterial disinfectant liquid cleaner has a cool menthol fragrance</li>
                    <li>DOCTOR RECOMMENDED: All Dettol products are recommended by the Indian Medical Association (IMA)</li>
                </ol>

                </p>
                <h4>&#8377 492 <s>&#8377 579</s></h4>
                <p class="off">28% OOF</p>
                </h4>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proda4');
                                $stmt->execute();
