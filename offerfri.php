...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/offerfri1.jpg" width="50%" id="ProductImg" style="padding-left: 80px;" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/offerfri1.jpg" width="70%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offerfri2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offerfri3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/offerfri4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <p></p>
                <h1>Samsung 657 L with Inverter Side-by-Side Refrigerator (RS74T5F01B4/TL, Matt Black)</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>

                    <li>Frost-free side-by-side refrigerator; 657 litres capacity</li>
                    <li>Warranty: 1 year on product, 10 years on compressor</li>
                    <li>Frost free refrigerator: auto defrost function to prevent ice build up</li>
                    <li>657L capacity: Suitable for family of 4 to 5 members</li>
                    <li>Digital inverter compressor – energy efficient, less noise & more durable</li>
                </p>
                <br>
                <h3>PRICE - &#8377 1,72,900 &nbsp;&nbsp;&nbsp; M.R.P -<s style="color: grey;"> &#8377 2,49,900</s></h3>
                <h3 style="color: red;">31% OFF</h3>
                <!-- <select name="" id="">
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM offerfri');
                                $stmt->execute();
