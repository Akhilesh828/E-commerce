...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/hancock_formal_navy_blue_shirt_4.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/hancock_formal_navy_blue_shirt_4.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/hancock_formal_navy_blue_shirt_3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/hancock_formal_navy_blue_shirt_2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/hancock_formal_navy_blue_shirt_1.webp" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <br>
                <ul>
                    <li>Navy Blue solid formal shirt, has a spread collar, long sleeves, straight hem, one patch pocket</li>
                    <li>Size & Fit
                        Slim fit
                ...
                <h3>PRICE - &#8377 1,299 &nbsp;&nbsp;&nbsp; <s style="color: grey;"> &#8377 1,599</s></h3>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proformensdetails1');
                                $stmt->execute();
...
------------------------------------------------------------------------- -->
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="proformensdetails3.php"><img src="images/louis_philippe_sport_blazer_4.jpg" alt=""></a>
            ...
            <div class="col-4">
                <a href="proformensdetails4.php"><img src="images/Men_single_brested_party_blazer_4.webp" alt=""></a>
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/peter_england_formal_pink_shirt_2.jpg" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_Mast_&_Harbour_black_blazer.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_park_avenue_formal_blazer.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_Van_heusen_checked_blazer.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_Van_heusen_formal_blazer.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
