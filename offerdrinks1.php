...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/coca1.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/coca1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/coca2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/coca3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/coca4.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                <p></p>
                <h1>Coca-Cola 300ml (Pack of 6)</h1>
                ...
                <p>
                    ...
                    <li>Enjoy coca-cola’s delicious taste with meals, on the go, or to share</li>
                    <li>Create refreshing moments for yourself with a can of coke</li>
                </p>
                <br>
                <h3>PRICE - &#8377  3,480 &nbsp;&nbsp;&nbsp; M.R.P -<s style="color: grey;"> &#8377 4,000</s></h3>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM offerdrinks1');
                                $stmt->execute();
