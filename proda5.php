...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/da34.jpg" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/da34.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da34.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da34.3.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/da34.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <h1>ORION Choco Pie - Chocolate Coated Soft Biscuit 6 Pcs Pack, 168 g</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                <ol style="list-style-type: circle;">
                    <li>Original choco pie - ORION choco pie is the first choco pie ever. Since its launch, it has been a delight and adding sweetness to the lives of many</li>
                    <li>Combining the goodness of rich chocolate coated cake with delicious soft marshmallow, this choco pie is a dream come true for people who have a sweet tooth</li>
                    <li>Gift pack - enrich festival celebrations with your friends and family with this special gift pack</li>
                    <li>100% Vegetarian
                        Each pack contains 6 units</li>
                </ol>

                </p>
                <h4>&#8377 150 <s>&#8377 155</s>
        ...
        <div class="row ">
            ...
            <div class="container">
                ...
                <div class="row mt-2 pb-3">
                    <?php
                    include 'config.php';
                    $stmt = $conn->prepare('SELECT * FROM proda5');
                    $stmt->execute();
