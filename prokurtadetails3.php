...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/house_of_pataudi_men_printed_kurta_01.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/house_of_pataudi_men_printed_kurta_01.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/house_of_pataudi_men_printed_kurta_02.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/house_of_pataudi_men_printed_kurta_03.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/house_of_pataudi_men_printed_kurta_04.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM prokurtadetails3');
                                $stmt->execute();
...
------------------------------------------------------------------------- -->
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <img src="images/01_fabindia_men_solid_straight_kurta.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <a href="proformensdetails1.php"><img src="images/01_louis_philippe_blue_blazer.jpg" alt=""></a>
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
