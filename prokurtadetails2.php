...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/manyavar_men_blue_jacquard_kurta_01.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/manyavar_men_blue_jacquard_kurta_01.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/manyavar_men_blue_jacquard_kurta_02.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/manyavar_men_blue_jacquard_kurta_03.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/manyavar_men_blue_jacquard_kurta_04.jpg" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <h1>Blue & white printed cotton kurta</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <li>green printed straight knee length kurta, has a mandarin collar, long sleeves, straight hem
                    White solid churidar, drawstring closure</li>
                <li>Size & Fit
                    The model (height 6') is wearing a size M</li>
                <li>Material & Care
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM prokurtadetails2');
                                $stmt->execute();
...
------------------------------------------------------------------------- -->
    ...
    <div class="small-container">
        <div class="row row-2">
            ...
            <a href="prokurta.php" class="btn">View More</a>
        </div>
    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                <a href=""><img src="images/vastramay_men_ethnic_motifs_kurta_01.webp" alt=""></a>
            ...
            <div class="col-4">
                <img src="images/manyavar_men_blue_jacquard_kurta_03.jpg" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_tabard_men_woven_kurta.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_jompers_men_kurta.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_jompers_men_red_kurta.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <img src="images/01_deyann_men_printed_green_kurta.webp" alt="">
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                <a href="proformensdetails1.php"><img src="images/Men_single_brested_party_blazer_4.webp" alt=""></a>
                <h4>REd Printed T-Shirt</h4>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
