...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="images/mask2.jpg" width="70%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/mask2.1.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/mask2.2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/mask2.jpg" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
            ...
            <div class="col-2">
                <p>Daily Essentials / Mask</p>
                <h1>Careview Non-Woven Fabric Reuseable N95 Mask (White, Without Valve, Pack of 10) for Unisex</h1>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                <ol style="list-style-type: circle;">
                    <li>A product of CE, GMP, ISO 9001:2015, ISO 13485:2016, EN 149: 2001 + A1 : 2009 certified Company.</li>
                    <li>Made with 6 Layered Filtration having 2 meltblown layers of 25 Gsm each. Also the innermost layer is Hydrophilic Spunbond SSS Grade fabric layer - 25 GSM which aborbs Sweat & Moisture making it perfect for long wearing hours</li>
                    <li>Hand Orientation Ambidextrous</li>
                    <li>High Protection, High Comfort and High Efficiency : High Comfort with breathing fabric, flexible ear loops and easy fit nose clip. High Efficiency by close facial fit with a strong seal around the nose and mouth.</li>
                    <li>100 Pcs Net</li>
                    <li>Made In India and designed in France</li>
                </ol>
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proda3');
                                $stmt->execute();
