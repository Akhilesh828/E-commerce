    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                ...
                <img src="images/men_slim_fit_formal_blazer_4.webp" width="100%" id="ProductImg" alt="">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/men_slim_fit_formal_blazer_4.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/men_slim_fit_formal_blazer_1.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/men_slim_fit_formal_blazer_2.webp" width="100%" class="small-img" alt="">
                    </div>
                    <div class="small-img-col">
                        <img src="images/men_slim_fit_formal_blazer_3.webp" width="100%" class="small-img" alt="">
                    </div>
                </div>
            ...
            <div class="col-2">
                ...
                <br>
                <ul>
                    <li>Yellow solid formal shirt, has a spread collar, long sleeves, straight hem, one patch pocket</li>
                    <li>Size & Fit
                        Slim fit
                    ...
                    <div class="row ">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-2 pb-3">
                                <?php
                                include 'config.php';
                                $stmt = $conn->prepare('SELECT * FROM proformensdetails5');
                                $stmt->execute();
