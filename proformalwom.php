...
<body>
  ...
  <div class="main">
    ...
    <h1>Formal Colthes for Womens</h1>
    <hr>
 ...
 -->
    ...
    <!-- <div class="categories">
      <div class="small-conatiner">
        <div class="row">
          <div class="col-3">
            <div class="content">
              <a href="proformalmens.php"><img src="images/cat-shirt.webp" alt=""></a>
            </div>
          </div>
          <div class="col-3">

            <a href=""><img src="images/gshirt10.webp" alt=""></a>
    ...
    <div class="row">
      <div class="column above 8k">
        <div class="content">
          <a href=""><img src="images/f1.jpg" alt="Mountains" style="width:90%"></a>
          <h4>Fashion2wear
            <h3>&#8377 12,000 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 18,000</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 2k">
        <div class="content">
          <a href=""><img src="images/gshirt2.webp" alt="Lights" style="width:100%"></a>
          
          <h4>MyBlush
            <h3>&#8377 1,299 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 1,788</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column above 8k">
        <div class="content">
          <a href=""><img src="images/gshirt3.webp" alt="Car" style="width:100%"></a>
          
          <h4>PURVAJA
            <h3>&#8377 8,010 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 10,788</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 2k">
        <div class="content">
          <a href=""><img src="images/gshirt4.webp" alt="Car" style="width:100%"></a>

          <h4>Khushal K
            <h3>&#8377 590 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 788</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 2k">
        <div class="content">
          <a href=""><img src="images/gshirt5.webp" alt="Car" style="width:100%"></a>
       
          <h4>Procent
            <h3>&#8377 1,490 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 2,788</s>
            </h3>
          </h4>
          <h4>
            <p class="off">(48% OFF)</p>
          </h4>
        </div>
      </div>
      ...
      <div class="column under 3k-8k">
        <div class="content">
          <img src="images/gshirt6.webp" alt="Car" style="width:100%">
          
          <h4>Stylum
            <h3>&#8377 2,590 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 4,788</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 2k">
        <div class="content">
          <img src="images/gshirt7.webp" alt="Car" style="width:100%">
      ...
      <div class="column under 3k-8k">
        <div class="content">
          <a href=""><img src="images/gshirt8.webp" alt="Car" style="width:100%"></a>
          
          <h4> VERO MODA
            <h3>&#8377 3,590 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 5,555</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 3k-8k">
        <div class="content">
          <img src="images/gshirt9.webp" alt="Car" style="width:100%">
        
          <h4>ADDYVERO
            <h3>&#8377 6,590 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 8,888</s>
            </h3>
          </h4>
          <h4>
      ...
      <div class="column under 3k-8k">
        <div class="content">
          <img src="images/gshirt10.webp" alt="Car" style="width:100%">
          
          <h4>Keiraa
            <h3>&#8377 4,449 &nbsp;&nbsp;&nbsp;&nbsp;
              <s style="color: grey;">&#8377 5,799</s>
            </h3>
          </h4>
          <h4>
